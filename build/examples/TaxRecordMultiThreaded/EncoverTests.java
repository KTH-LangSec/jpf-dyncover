...
class EncoverTests {
  ...
  public static void simplestTest(int incomeAlice) {
    ...
    TaxPayer alice = new TaxPayer("Alice", record_Alice, TaxPayer.Scenario.UNDER, 0, 0);
  ...
  public static void onePayer(int incomeAlice, int charityAlice, int paymentAlice) {
    ...
    TaxPayer alice = new TaxPayer("Alice", recordAlice, TaxPayer.Scenario.TRY, charityAlice, paymentAlice);
  ...
  public static void twoPayers(int incomeAlice, int charityAlice, int paymentAlice,
    ...
    TaxPayer bob = new TaxPayer("Bob", recordBob, TaxPayer.Scenario.TRY, charityBob, paymentBob);
